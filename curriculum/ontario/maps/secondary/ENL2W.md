...
> **Note:** Use official Ontario curriculum documents only. Paste **verbatim** overall & specific expectations and keep all codes exactly as published.
...
### Strand A — Literacy Connections and Applications
- **A1**: demonstrate an understanding of how transferable skills (e.g., collaboration, communication, critical thinking, digital literacy) are applied in various language and literacy contexts
- **A2**: apply safe, responsible, and ethical practices in digital and online environments when consuming and creating texts
...
### Strand B — Reading and Literature Studies
- **B1.1**: read and demonstrate understanding of a variety of increasingly complex literary texts from diverse cultures and perspectives, including Indigenous voices
- **B1.2**: analyse themes, ideas, and perspectives in texts, citing evidence to support interpretations
- **B2.1**: identify and explain text forms, features, and stylistic elements in literary and informational texts, and analyse how they shape meaning
